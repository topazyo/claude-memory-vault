...
never changes one already there, proposing such changes in its report instead, and its runner
refuses a pass that does (exit 2). Those two runners also fail a pass that writes outside
